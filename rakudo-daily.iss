...
AppId={{48B63F54-382A-4887-AFE2-47AF103CD33C}
AppName={#MyAppName}
...
OutputDir=.
OutputBaseFilename=rakudo-daily-x86_64(JIT)
...
[Files]
Source: "C:\projects\rakudo\rakudo-new\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
